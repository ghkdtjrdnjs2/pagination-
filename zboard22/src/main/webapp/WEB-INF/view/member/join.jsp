				...
				<form id="join_form" method="post" action="/member/join"
					...
					<div class="mb-3 mt-3">
						<label for="profile">프로필 사진:</label> <input type="file"
							id="profile" name="profile" accept=".jpg,.jpeg,.png"
							class="form-control" />
					</div>
					<div class="mb-3 mt-3">
					...
					<div class="mb-3 mt-3">
						<label for="password2">비밀번호 확인:</label> <input type="password"
							id="password2" class="form-control" /> <span class="message"></span>
					</div>
					<div class="mb-3 mt-3">
						<label for="email">이메일:</label> <input type="text" name="email"
							id="email" class="form-control" /> <span class="message"></span>
					</div>
					<div class="mb-3 mt-3">
						<label for="birthday">생일(선택):</label> <input type="date"
							name="birthday" id="birthday" class="form-control" /> <span
							class="message"></span>
					</div>
